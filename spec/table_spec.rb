...
describe DataTable::Table do
  context "with a non-empty collection of hashes" do
    ...
    it "should render a table with the 'no records' message" do
      expect(data_table.render).to \
        eq(%{<table id='' class='data_table ' cellspacing='0' cellpadding='0'><caption><span class=''></span></caption><thead><tr></tr></thead><tr><td class='empty_data_table' colspan='0'>No records found</td></tr></table>})
    end
    ...
    it "should render a custom empty text notice" do
      ...
      expect(data_table.render).to \
      eq(%{<table id='' class='data_table ' cellspacing='0' cellpadding='0'><caption><span class=''></span></caption><thead><tr></tr></thead><tr><td class='empty_data_table' colspan='0'>#{text}</td></tr></table>})
    end
